...
class UpdateController extends Controller
{
    ...
    public function update_software(Request $request)
    {
        ...
        $this->setEnvironmentValue('PUSHER_APP_ID', 'e-ride');
        $this->setEnvironmentValue('PUSHER_APP_KEY', 'e-ride');
        $this->setEnvironmentValue('PUSHER_APP_SECRET', 'e-ride');
        ...
        $this->setEnvironmentValue('REVERB_APP_ID', 'e-ride');
        $this->setEnvironmentValue('REVERB_APP_KEY', 'e-ride');
        $this->setEnvironmentValue('REVERB_APP_SECRET', 'e-ride');
