...
@push('css_or_js')
    <link rel="stylesheet" href="{{ dynamicAsset('public/landing-page/assets/css/owl.min.css') }}"/>
@endpush
...
@section('content')
    ...
    <span id="get-file-icon" data-default-icon="{{ dynamicAsset('public/assets/admin-module/img/default-icon.png') }}"
          data-word-icon="{{ dynamicAsset('public/assets/admin-module/img/default-icon.png') }}"></span>
@endsection

@push('script')
    <script src="{{ dynamicAsset('public/assets/admin-module/js/chatting/chatting.js') }}"></script>
    <script src="{{ dynamicAsset('public/assets/admin-module/js/chatting/picmo-emoji.js') }}"></script>
    <script src="{{ dynamicAsset('public/landing-page/assets/js/owl.min.js') }}"></script>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function onSuccess(response) {
                ...
                $.getScript(
                    "{{ dynamicAsset('public/assets/admin-module/js/chatting/select-multiple-image-for-message.js') }}"
                );
                $.getScript("{{ dynamicAsset('public/assets/admin-module/js/js-zip/jszip.min.js') }}");
                $.getScript("{{ dynamicAsset('public/assets/admin-module/js/js-zip/FileSaver.min.js') }}");
                //tooltip
