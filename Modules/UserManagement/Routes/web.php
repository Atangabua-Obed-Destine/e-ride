...
use Modules\UserManagement\Http\Controllers\NewsletterController;
use Modules\UserManagement\Http\Controllers\Web\Admin\CashCollectController;
use Modules\UserManagement\Http\Controllers\Web\Admin\Customer\CustomerController;
use Modules\UserManagement\Http\Controllers\Web\Admin\Customer\CustomerLevelController;
use Modules\UserManagement\Http\Controllers\Web\Admin\Customer\CustomerWalletController;
...
use Modules\UserManagement\Http\Controllers\Web\Admin\WalletBonusController;
    ...
    Route::group(['prefix' => 'driver', 'as' => 'driver.'], function () {
        ...
        Route::group(['prefix' => 'verification', 'as' => 'verification.'], function () {
            Route::controller(IdentityVerificationController::class)->group(function () {
                Route::get('unverified-list', 'unverifiedList')->name('unverified-list');
                Route::get('export-unverified-list', 'exportUnverifiedList')->name('export-unverified-list');
                Route::get('view-verification-request/{id}', 'viewVerificationRequest')->name('view-verification-request');
                Route::post('mark-as-verified/{id}', 'markAsVerified')->name('mark-as-verified');
                Route::get('mark-as-suspended/{id}', 'markAsSuspended')->name('mark-as-suspended');
            });
        });
