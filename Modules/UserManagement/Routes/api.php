    ...
    Route::group(['middleware' => ['auth:api', 'maintenance_mode']], function () {
        ...
        Route::group(['prefix' => 'wallet'], function () {
            Route::controller(WalletTransferController::class)->group(function () {
                Route::post('transfer-e-ride-to-mart', 'transferE-RideToMartWallet');
                Route::post('transfer-e-ride-from-mart', 'transferE-RideFromMartWallet')->withoutMiddleware('auth:api');
            });
