<div class="row justify-content-center g-2 g-xl-3">
        ...
        <div class="card border text-center analytical_data">
            <div class="card-body">
                <div class="analytical_data-icon rounded-circle mx-auto">
                    <img src="{{dynamicAsset('public/assets/admin-module/img/svg/total_customer.svg')}}" class="svg" alt="">
                </div>
    ...
    <div class="col-xl-2 col-lg-3 col-md-4 col-6">
        <div class="card border text-center analytical_data analytical_data-color2">
            <div class="card-body">
                <div class="analytical_data-icon rounded-circle mx-auto">
                    <img src="{{dynamicAsset('public/assets/admin-module/img/svg/active_customer.svg')}}" class="svg" alt="">
                </div>
    ...
    <div class="col-xl-2 col-lg-3 col-md-4 col-6">
        <div class="card border text-center analytical_data analytical_data-color3">
            <div class="card-body">
                <div class="analytical_data-icon rounded-circle mx-auto">
                    <img src="{{dynamicAsset('public/assets/admin-module/img/svg/inactive_customer.svg')}}" class="svg" alt="">
                </div>
    ...
    <div class="col-xl-2 col-lg-3 col-md-4 col-6">
        <div class="card border text-center analytical_data analytical_data-color4">
            <div class="card-body">
                <div class="analytical_data-icon rounded-circle mx-auto">
                    <img src="{{dynamicAsset('public/assets/admin-module/img/svg/new_customer.svg')}}" class="svg" alt="">
                </div>
    ...
    <div class="col-xl-2 col-lg-3 col-md-4 col-6">
        <div class="card border text-center analytical_data analytical_data-color5">
            <div class="card-body">
                <div class="analytical_data-icon rounded-circle mx-auto">
                    <img src="{{dynamicAsset('public/assets/admin-module/img/svg/loyal_customer.svg')}}" class="svg" alt="">
                </div>
