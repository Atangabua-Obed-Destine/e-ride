...
class TripFareSettingController extends BaseController
{
    ...
    public function __construct(BusinessSettingServiceInterface $businessSettingService, CancellationReasonServiceInterface $cancellationReasonService, VehicleCategoryServiceInterface $vehicleCategoryService)
    {
    ...
    {
        $this->authorize('business_view');
        $settings = $this->businessSettingService->getBy(whereInCriteria: ['settings_type' => [TRIP_SETTINGS, SCHEDULE_TRIP_SETTINGS]]);
